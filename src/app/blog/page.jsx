...
function safeComponent(Component, fallback = () => null) {
...
export async function generateMetadata({ params: maybeParams }) {
  ...
  const { title = "Default Blog Title", description = "Default blog description", keywords = [], author = "Default Author", publishedAt, updatedAt } = frontmatter;
...
export default async function BlogPage({ params: maybeParams }) {
  ...
  const { content, frontmatter } = await compileMDX({
    ...
    components: {
      Link,
      BlogImage: safeComponent(blogComponents.BlogImage),
      BlogHeader: safeComponent(() => <blogComponents.BlogHeader {...frontmatter} />),
      AuthorCard: safeComponent(() => (
